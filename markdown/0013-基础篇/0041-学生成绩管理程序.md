...
struct record
{
	...
	char 	code[CODELEN+1];	[Tags]/* 学号 */
	int 	marks[SWN];		[Tags]/* 各课程成绩 */
	int total;			[Tags]/* 总分 */
}stu;
struct node
{
...
int total[SWN];		[Tags]/* 各课程总分 */
FILE *stfpt;		[Tags]/* 文件指针 */
char stuf[FNAMELEN];	[Tags]/* 文件名 */
[Tags]/* 从指定文件读入一个记录 */
