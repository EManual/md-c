...
void getti(int a,int y,int z)   [Tags]/*a:满瓶的容量  y:第一个空瓶的容量  z:第二个空瓶的容量*/
{
   int b=0,c=0,j=0;           [Tags]/* b:第一瓶实际的重量  c:第二瓶实际的重量 j: 倒的步数*/
   ...
   while(a!=i||b!=i&&c!=i)      [Tags]/*当满瓶!=i或另两瓶都!=i*/
   {
      if(!b)
      {  a-=y; b=y;}    [Tags]/*如果第一瓶为空，则将满瓶倒入第一瓶中*/
      else if(c==z)
      {  a+=z; c=0;}    [Tags]/*如果第二瓶满，则将第二瓶倒入满瓶中*/
      else if(b>z-c)    [Tags]/*如果第一瓶的重量>第二瓶的剩余空间*/
      { b-=(z-c);c=z;}    [Tags]/*则将装满第二瓶，第一瓶中保留剩余部分*/
      else{ c+=b; b=0;}   [Tags]/*否则，将第一瓶全部倒入第二瓶中*/
      printf("   <%d>   | %4d %4d %4d\n",j++,a,b,c);
   }
   printf("-----------------------------\n");
}
