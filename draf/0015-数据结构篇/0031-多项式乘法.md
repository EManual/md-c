...
static double p[6]={4,-6,3,1,-1,5};	[Tags]/*表示多项式4x^5 - 6x^4 + 3x^3 + x^2 - x + 5 */
static double q[4]={3,2,-5,1};		[Tags]/*表示多项式3x^3 + 2x^2 - 5x + 1 */
static double result[9]={0,0,0,0,0,0,0,0,0};		[Tags]/*存放乘积多项式*/
...
double compute(s,k,x)	[Tags]/*计算所给多项式的值*/
double s[];
int k;
float x;
{
...
void main()
{
	...
	for (i=m+n-1,j=0;i>=1;i--)		[Tags]/*逐行逐项打印出结果多项式*/
	{
