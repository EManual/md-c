...
typedef struct
{
	int *pBase;[Tags]/*在构造之前和销毁之后,base的值为NULL*/
	int *pTop;[Tags]/*栈顶指针*/
	int StackSize;[Tags]/*当前已分配的存储空间,以元素为单位*/
}Stack;
typedef int BOOLEAN;
char Operator[8]="+-*/()";[Tags]/*合法的操作符存储在字符串中*/
char Optr;[Tags]/*操作符*/
int Opnd=-1;[Tags]/*操作符*/
int Result;[Tags]/*操作结果*/
[Tags]/*算符间的优先关系*/
